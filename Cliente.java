					...
					switch(id_a)
					 {
					 	...
					 	case -5: out.println("Error en el pago de la apuesta: No tiene saldo suficiente en la tarjeta.");
					 		break;
					 	case -6 -7 -10 -11: out.println("Error en el pago de la apuesta.");
					 		break;
					 	case -12 -13 -14: out.println("Error al almacenar la apuesta.");
					...
					switch(id_a)
					 {
					 	...
					 	case -6: case -7: case -10: case -11: out.println("Error en el pago de la apuesta.");
					 		break;
					 	case -12: case -13: case -14: out.println("Error al almacenar la apuesta.");
					 	default: out.println("Error no conocido: "+id_a);
					 		break;
					 }
					...
					switch((int)Math.floor(ganancia))
					 {
					 	case -1: case -4: case -10: out.println("No se encuentra el identificador de la apuesta en la base de datos");
					 		break;
					 	case -2: case -3: case -11: case -12: out.println("Error con el identificador de la apuesta al partido");
					 		break;
					 	case -5: case -6: case -7: case -13: case -14: out.println("Error con el identificador de la apuesta al pichichi");
					 		break;
	...
	public Partido getPartido(int id_p)
	 {
		...
		return new Partido(id_p, equipo1, equipo2);
	 }
