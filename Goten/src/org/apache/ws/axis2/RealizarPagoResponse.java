...
/**
 *  RealizarPagoResponse bean class
 */
@SuppressWarnings({"unused", "serial"
})
public class RealizarPagoResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://ws.apache.org/axis2",
            "realizarPagoResponse", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":realizarPagoResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "realizarPagoResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RealizarPagoResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RealizarPagoResponse object = new RealizarPagoResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"realizarPagoResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RealizarPagoResponse) org.apache.ws.axis2.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
