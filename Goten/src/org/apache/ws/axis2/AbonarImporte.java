...
/**
 *  AbonarImporte bean class
 */
@SuppressWarnings({"unused", "serial"
})
public class AbonarImporte implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":abonarImporte", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "abonarImporte", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static AbonarImporte parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AbonarImporte object = new AbonarImporte();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"abonarImporte".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (AbonarImporte) org.apache.ws.axis2.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
