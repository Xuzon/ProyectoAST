...
/**
 *  ApostarPichichiResponse bean class
 */
@SuppressWarnings({"unused", "serial"
})
public class ApostarPichichiResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://ws.apache.org/axis2",
            "apostarPichichiResponse", "ns2");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":apostarPichichiResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "apostarPichichiResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ApostarPichichiResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ApostarPichichiResponse object = new ApostarPichichiResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"apostarPichichiResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ApostarPichichiResponse) org.apache.ws.axis2.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
