...
/**
 *  ApostarPartidoResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ApostarPartidoResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://ws.apache.org/axis2",
            "apostarPartidoResponse", "ns2");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":apostarPartidoResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "apostarPartidoResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ApostarPartidoResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ApostarPartidoResponse object = new ApostarPartidoResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"apostarPartidoResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ApostarPartidoResponse) org.apache.ws.axis2.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
