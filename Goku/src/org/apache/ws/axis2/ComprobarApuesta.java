...
/**
 *  ComprobarApuesta bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ComprobarApuesta implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":comprobarApuesta", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "comprobarApuesta", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ComprobarApuesta parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ComprobarApuesta object = new ComprobarApuesta();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"comprobarApuesta".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ComprobarApuesta) org.apache.ws.axis2.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
