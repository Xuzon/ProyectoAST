...
/**
 *  ApostarPichichi bean class
 */
@SuppressWarnings({"unused", "serial"
})
public class ApostarPichichi implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":apostarPichichi", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "apostarPichichi", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ApostarPichichi parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ApostarPichichi object = new ApostarPichichi();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"apostarPichichi".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ApostarPichichi) org.apache.ws.axis2.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
