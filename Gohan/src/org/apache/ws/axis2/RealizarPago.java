...
/**
 *  RealizarPago bean class
 */
@SuppressWarnings({"unused", "serial"
})
public class RealizarPago implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":realizarPago", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "realizarPago", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RealizarPago parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RealizarPago object = new RealizarPago();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"realizarPago".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RealizarPago) org.apache.ws.axis2.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
