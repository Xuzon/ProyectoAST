...
/**
 *  AbonarImporteResponse bean class
 */
@SuppressWarnings({"unused", "serial"
})
public class AbonarImporteResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://ws.apache.org/axis2",
            "abonarImporteResponse", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":abonarImporteResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "abonarImporteResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static AbonarImporteResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AbonarImporteResponse object = new AbonarImporteResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"abonarImporteResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (AbonarImporteResponse) org.apache.ws.axis2.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
